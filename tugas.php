...
<body>
    ...
    <form method="post" action="tampil.php">
        ...
        <label for="np">Nilai Produktif</label> <br>
        ...
        <label for="ns">Nilai Pipas</label> <br><br>
        <input type="number" name="ns"><br><br>
       
        <label for="nd">Nilai Sunda</label> <br><br>
        <input type="number" name="nd"><br><br>

        <label for="nj">Nilai PJOK</label> <br><br>
        <input type="number" name="nj"><br><br>

        <label for="nf">Nilai Informatika</label> <br><br>
